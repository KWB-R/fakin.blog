...
- Problem, Software zu finden
- GitHub + DOI
- Allianzinitiative: FAIR (f = findability, ...)
...
- Anja: Metadaten-Harvesting
- Birte Pfeiffer: Suche nach Datenerhebungs-Tools
- Wie wurde gesucht?
- mybinder (Vorschlag von Michael Rustler)
...
- [daten.berlin.de](daten.berlin.de), data.deutschebahn.de
...
**Alexander Struck, HU Berlin**: We may have a look at [Seafile](https://www.seafile.com/en/home/) as a free software tool for storing 
our raw data.
